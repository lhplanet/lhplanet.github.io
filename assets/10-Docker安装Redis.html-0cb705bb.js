import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as l,d}from"./app-42cc0bba.js";const s={},a=d(`<h2 id="docker安装redis" tabindex="-1"><a class="header-anchor" href="#docker安装redis" aria-hidden="true">#</a> Docker安装Redis</h2><p>以 Redis 6.0.8 为例：</p><div class="language-Shell line-numbers-mode" data-ext="Shell"><pre class="language-Shell"><code>docker pull redis:6.0.8
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,163),n=[a];function r(c,t){return i(),l("div",null,n)}const u=e(s,[["render",r],["__file","10-Docker安装Redis.html.vue"]]);export{u as default};
