import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as l,c as i,d as s}from"./app-80c0fd9a.js";const a={},n=s(`<h2 id="docker-安装-mysql" tabindex="-1"><a class="header-anchor" href="#docker-安装-mysql" aria-hidden="true">#</a> Docker 安装 Mysql</h2><p>以安装 Mysql 5.7为例：</p><div class="language-Shell line-numbers-mode" data-ext="Shell"><pre class="language-Shell"><code>docker pull mysql:5.7
...
use db01;
select * from t1;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,70),d=[n];function r(v,c){return l(),i("div",null,d)}const t=e(a,[["render",r],["__file","09-Docker安装MySQL.html.vue"]]);export{t as default};
