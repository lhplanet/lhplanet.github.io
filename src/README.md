...
#icon: home
title: 首页
#heroImage: /logo.svg # 网站 Logo 图标
bgImage: /bg.svg # 白天模式背景图片
bgImageDark: /bg.svg # 黑夜模式背景图片
bgImageStyle:
  background-attachment: fixed # 背景图片固定
heroFullScreen: true
heroText: 零号星球图书馆
tagline: <b>LHPlanet Library</b><br/><br/>欢迎来到零号星球图书馆！我是零号星球的创始人，零号星球官方图书馆正在建设当中。这里将收录包括但不限于 Java、C++、Vue 等多元技术的学习笔记。欢迎您在这里漫游，与我一同穿越代码的星空，拾阶而上，览尽创新的星辰！
#tagline: 欢迎来到零号星球图书馆！我是零号星球的创始人，零号星球官方图书馆正在建设当中。这里将收录包括但不限于 Java、C++、Vue 等多元技术的学习笔记。欢迎您在这里漫游，与我一同穿越代码的星空，拾阶而上，览尽创新的星辰！
#actions:
#  - text: 使用指南 💡
#    link: ./demo/
#    type: primary
...
#    link: https://github.com/lhplanet
